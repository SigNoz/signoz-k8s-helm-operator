...
# signoz.io/signoz-k8s-helm-operator-bundle:$VERSION and signoz.io/signoz-k8s-helm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= signoz.io/signoz-k8s-helm-operator
